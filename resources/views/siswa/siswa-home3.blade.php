    ...
    <div class="p-4 rounded-md mt-14 bg-white">
        <div class="m-4">
            ...
            <div class="mb-8 py-2">
                ...
                <span class="font-small mt-2">Display Students for <a class="text-yellow-600 font-medium">Class XII</a></span>
            </div>
            ...
            <!-- Form Filter -->
            <form action="{{ route('siswa-filtered-3') }}" method="GET">
            ...
            <table class="w-full text-sm text-left text-gray-500 ">
                ...
                @if ($siswa->isEmpty())
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-3 py-2">{{ $siswa->kelas->waliKelas ? $siswa->kelas->waliKelas->name : 'Tidak ada wali kelas' }}</td>
