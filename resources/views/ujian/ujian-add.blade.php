...
<div class="p-4 sm:ml-52">
    <div class="p-4 rounded-md mt-14 bg-white">
        <div class="m-4">
            ...
            <h5 class="mb-2 py-2 text-2xl font-medium tracking-tight">Add Exam Type</h5>
            ...
            <form action="{{ route('ujian-insert')}}" method="POST">
                @csrf
                <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                    <label for="name" class="self-center text-gray-600">Exam Name</label>
                    <div class="relative z-0 w-full mb-5">
                        <input type="text" name="name" autocomplete="name" value="{{ old('name') }}" placeholder="" required class="pt-3 pb-2 px-3 block w-full mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200">
                    </div>
                </div>
                <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
