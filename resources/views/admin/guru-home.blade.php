...
<div class="p-4 sm:ml-56">
    <div class="p-4 rounded-md mt-14 bg-white">
        <div class="m-4">
            <h5 class="text-2xl font-medium tracking-tight">Teacher</h5>
            ...
            <div class="py-8 flex flex-row-reverse">
                <a href="{{ route('guru-add')}}" class="max-w-20 min-w-20 text-white text-sm text-center py-2 px-4 ml-2 bg-blue-600 rounded hover:bg-blue-800">
                    Tambah
                </a>
                <!--
            ...
            <table class="w-full text-sm text-left text-gray-500 ">
                ...
                <tbody class="text-gray-700">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-3 py-2">{{ $guru->role }}</td>
                        <td class="px-3 py-2">{{ $guru->name }}</td>
                        <td class="px-3 py-2">{{ $guru->email }}</td>
                        <td class="px-3 py-2">{{ $guru->updated_at->format('l, d F Y') }}</td>
                        <td class="px-3 py-2">
                            <div class="flex flex-row space-x-4">
                                <div>
                                    <a href="/admin/guru-view/{{  $guru->id }}" class="text-blue-600 hover:text-blue-900">
                                    &laquo view &raquo
                                    </a>
                                </div>
                                <div>
                                    <a href="{{  route('guru-update-form', $guru->id) }}" class="text-blue-600 hover:text-blue-900">
                                    &laquo update &raquo
                                    </a>
                                </div>
                                <div>
                                    <a href="/admin/guru-delete/{{  $guru->id }}" class="text-blue-600 hover:text-blue-900">
                                    &laquo delete &raquo
                                    </a>
                                </div>
                            </div>
