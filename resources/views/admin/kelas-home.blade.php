                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-3 py-2">
                            <div class="flex flex-row space-x-4">
                                <div>
                                    <a href="/admin/kelas-view/{{  $kelas->id }}" class="text-blue-600 hover:text-blue-900">
                                    &laquo view &raquo
                                    </a>
                                </div>
                                <div>
                                    <a href="{{  route('kelas-update-form', $kelas->id) }}" class="text-blue-600 hover:text-blue-900">
                                    &laquo update &raquo
                                    </a>
                                </div>
                                <div>
                                    <a href="/admin/kelas-delete/{{  $kelas->id }}" class="text-blue-600 hover:text-blue-900">
                                    &laquo delete &raquo
                                    </a>
                                </div>
                            </div>
